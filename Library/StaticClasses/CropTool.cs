    ...
    public static class CropTool
    {
        ...
        public static void Activate(CanvasView Target, ref Bitmap canvas, ref Graphics canvasGraphics, bool IsSelectAreaActive = false)
        {
            ...
            else
            {
                ...
                canvas = new Bitmap((int)Math.Round(SelectTool.SelectArea.Width / AppState.ZoomFactor), (int)Math.Round(SelectTool.SelectArea.Height / AppState.ZoomFactor));
        ...
        private static void DoAllTheStuff(CanvasView Target, ref Bitmap canvas, ref Graphics canvasGraphics, Bitmap temp)
        {
            ...
            if (MouseTracker.HorizontalDistance < 0 && MouseTracker.VerticalDistance > 0)
            {
                ...
                {
                    Target.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppState.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppState.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
            ...
            else if (MouseTracker.HorizontalDistance > 0 && MouseTracker.VerticalDistance < 0)
            {
                if (Target.ClientRectangle.Contains(new Point((int)Math.Round(MouseTracker.MouseMovePoint.X * AppState.ZoomFactor), (int)Math.Round(MouseTracker.MouseMovePoint.Y * AppState.ZoomFactor))))
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppState.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppState.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
            ...
            else if (MouseTracker.HorizontalDistance < 0 && MouseTracker.VerticalDistance < 0)
            {
                if (Target.ClientRectangle.Contains(new Point((int)Math.Round(MouseTracker.MouseMovePoint.X * AppState.ZoomFactor), (int)Math.Round(MouseTracker.MouseMovePoint.Y * AppState.ZoomFactor))))
                {
                    Target.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppState.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppState.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
            ...
            else
            {
                if (Target.ClientRectangle.Contains(new Point((int)Math.Round(MouseTracker.MouseMovePoint.X * AppState.ZoomFactor), (int)Math.Round(MouseTracker.MouseMovePoint.Y * AppState.ZoomFactor))))
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppState.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppState.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
                ...
                {
                    Target.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppState.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppState.ZoomFactor));
