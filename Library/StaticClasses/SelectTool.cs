    ...
    public static class SelectTool
    {
        ...
        public static void SelectSomeArea(CanvasView Target, Bitmap canvas)
        {
            ...
            if (MouseTracker.HorizontalDistance < 0 && MouseTracker.VerticalDistance > 0)
            {
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppManager.State.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
            ...
            else if (MouseTracker.HorizontalDistance > 0 && MouseTracker.VerticalDistance < 0)
            {
                if (Target.ClientRectangle.Contains(new Point((int)Math.Round(MouseTracker.MouseMovePoint.X * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.MouseMovePoint.Y * AppManager.State.ZoomFactor))))
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppManager.State.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
            ...
            else if (MouseTracker.HorizontalDistance < 0 && MouseTracker.VerticalDistance < 0)
            {
                if (Target.ClientRectangle.Contains(new Point((int)Math.Round(MouseTracker.MouseMovePoint.X * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.MouseMovePoint.Y * AppManager.State.ZoomFactor))))
                {
                    SelectArea.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppManager.State.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(Math.Abs(MouseTracker.VerticalDistance) * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(Math.Abs(MouseTracker.HorizontalDistance) * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
            ...
            else
            {
                if (Target.ClientRectangle.Contains(new Point((int)Math.Round(MouseTracker.MouseMovePoint.X * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.MouseMovePoint.Y * AppManager.State.ZoomFactor))))
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(MouseTracker.VerticalDistance * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(MouseTracker.HorizontalDistance * AppManager.State.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
                ...
                {
                    SelectArea.Size = new Size((int)Math.Round(Target.Width - MouseTracker.MouseDownPoint.X * AppManager.State.ZoomFactor), (int)Math.Round(Target.Height - MouseTracker.MouseDownPoint.Y * AppManager.State.ZoomFactor));
            ...
            SelectArea.Location = new Point((int)Math.Round(drawRect.X * AppManager.State.ZoomFactor), (int)Math.Round(drawRect.Y * AppManager.State.ZoomFactor));
        ...
        public static void SelectPastedImage(CanvasView Target, Bitmap image)
        {
            ...
            SelectArea = new SelectArea();
            SelectArea.Paint += SelectArea_Paint;
            SelectArea.Size = new Size((int)Math.Round(image.Width * AppManager.State.ZoomFactor), (int)Math.Round(image.Height * AppManager.State.ZoomFactor));
        ...
        public static void SelectAreaDispose(CanvasView Target, Bitmap canvas)
        {
            ...
            canvasGraphics.DrawImage(SelectArea.Image, SelectArea.Left / AppManager.State.ZoomFactor, SelectArea.Top / AppManager.State.ZoomFactor, SelectArea.Width / AppManager.State.ZoomFactor, SelectArea.Height / AppManager.State.ZoomFactor);
